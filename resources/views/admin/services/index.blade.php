@extends('layouts.app')
@include('extension.admin.service.createServiceModal')
        ...
        <section class="content">
            ...
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool py-3" data-toggle="modal" data-target="#createServiceModal">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($services as $row)
                                ...
                                @include('extension.admin.service.deleteServiceModal')
                                @section('deleteServiceModal')
                                @endsection

                                <!-- Service Edit Modal -->
                                @include('extension.admin.service.editServiceModal')
                                @section('editServiceModal')
                                @endsection
                        </tbody>
                        @endforeach
                        @if (session('message'))
                            <div class="alert alert-success m-2 text-white">
                                {{ session('message') }}
                            </div>
