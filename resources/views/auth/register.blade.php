                    ...
                    <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="login-tab" data-toggle="tab" href="#login" role="tab"
                                aria-controls="login" aria-selected="true">Register User</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="register-tab" data-toggle="tab" href="#register" role="tab"
                                aria-controls="register" aria-selected="false">Register Shop</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                        ...
                        <div class="tab-pane fade show" id="register" role="tabpanel" aria-labelledby="register-tab">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <input id="role" type="text"
                                    class="form-control @error('role') is-invalid @enderror d-none" name="role"
                                    value="{{ old('role', 2) }}" required autocomplete="name" autofocus>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <input id="name" type="text"
                                        class="form-control @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name') }}" placeholder="Owner Name" required
