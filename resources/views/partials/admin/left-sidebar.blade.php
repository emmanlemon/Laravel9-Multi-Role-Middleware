          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  <li class="nav-item">
                      <a href="{{ route('home.admin') }}" class="nav-link {{ Route::current()->getName() == "home.admin" ? 'active' : '' }}">
                  ...
                  <li class="nav-item">
                      <a href="{{ route('shops.myShop') }}" class="nav-link {{ Route::current()->getName() == "shops.myShop" ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          {{-- {{ Route::current()->getName() }} --}}
                          <p>My Shop</p>
                      </a>
